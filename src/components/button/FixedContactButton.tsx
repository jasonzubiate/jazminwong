...
export default function FixedContactButton() {
  ...
  return (
    <button
      ...
      } flex items-center gap-3 fixed bottom-8 left-1/2 -translate-x-1/2 pl-1 py-1 pr-6 rounded-full cursor-pointer group z-999`}
    >
      <div className="h-12 w-12 relative rounded-full">
        <div className="w-full h-full rounded-full overflow-hidden relative group-hover:opacity-0 group-hover:scale-70 transition-all duration-200 ease-[cubic-bezier(0.64,0.57,0.67,1.53)]">
          <Image
        ...
        <span className="flex items-center justify-center h-12 w-12 bg-[#FBC1D5] rounded-full scale-0 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 group-hover:scale-100 transition-all duration-200 ease-[cubic-bezier(0.64,0.57,0.67,1.53)]">
          <IconMail className="text-stone-900" size={28} stroke={2.5} />
        </span>

        <span className={`${isOpen ? "scale-100" : "scale-0"} h-12 w-12 bg-stone-100 rounded-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden flex items-center justify-end`}>
